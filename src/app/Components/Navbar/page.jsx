...
function Navbar() {
  ...
  return (
    <>
      <nav
        className="flex flex-row ml-4 font-mono sm:mt-0 mt-4  md:ml-4 sm:flex sm:w-full  gap-4 sm:items-center sm:justify-between px-4 md:px-6 lg:px-16 xl:px-24 2xl:px-48  "
      >
        <Link href="/">
          <Image
            src={Logo2}
        ...
        {isMobile ? (
          <>
            ...
            >
              ...
              <Link href="/Unisex">
                <MenuItem onClick={handleMenuClose}>Unisex</MenuItem>
              </Link>
            </Menu>
          </>
        ) : (
